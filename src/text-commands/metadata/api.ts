 ...
 */
export function getTextCommandMetas(): Collection<
  Constructor,
  TextCommandMeta
> {
 ...
 * @returns
 */
export function setTextCommandMetas(
  metas: Collection<Constructor, TextCommandMeta>
) {
 ...
 * @returns
 */
export function addTextValidatorMethod(
  target: Constructor,
  argName: string,
  methodName: string
) {
 ...
 */
export function addTextArgValidator(
  target: Constructor,
  argName: string,
 ...
 * @returns
 */
export function setTextParserMetas(
  metas: Collection<string, TextArgParserMeta>
) {
