...
let UppercaseStringParser = class UppercaseStringParser extends TextArgParser_1.TextArgParser {
    constructor() {
        ...
        this.description = 'An uppercase string. Use "QUOTES FOR SPACES".';
    }
    parse(arg, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            throw new errors_1.TextArgError(`Expected an uppercase string, got "${str}".`);
        });
    }
};
UppercaseStringParser = __decorate([
    (0, decorators_1.parser)()
], UppercaseStringParser);
exports.UppercaseStringParser = UppercaseStringParser;
//# sourceMappingURL=UppercaseString.js.map