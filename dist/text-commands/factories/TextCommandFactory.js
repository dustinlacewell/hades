...
const TextArgumentInstaller_1 = require("./TextArgumentInstaller");
const InferenceService_1 = require("../services/InferenceService");
const ParserRegistry_1 = require("../services/ParserRegistry");
...
class TextCommandFactory {
    constructor(parentContainer, meta) {
        ...
        this.inferenceService = parentContainer.get(InferenceService_1.InferenceService);
        this.parserService = parentContainer.get(ParserRegistry_1.ParserRegistry);
        ...
        for (let [argName, argMeta] of meta.args) {
            ...
            const arg = new TextArgumentInstaller_1.TextArgumentInstaller(argMeta, parser);
